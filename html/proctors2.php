...
SQL;
	   ...
	   function startIsValued($pdo,$stud_id,$test_id,$print) //checks if test_start_time is valued or not for given reservation. 
	   {
		   $sql = <<<'SQL'
...
SQL;
	     ...
	     {
              echo"<UL><p> You have not given this test a Start time</p></UL>";
	     }
	   }
